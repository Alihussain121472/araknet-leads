            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  isActive
                    ? 'bg-brand-primary/15 text-brand-primary border border-blue-500/30 shadow-sm'
                    : 'text-text-secondary hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/50'
                }`}
              >
                <div className="flex items-center gap-3">
                  <Icon className={`w-4 h-4 ${isActive ? 'text-brand-primary' : 'text-text-secondary'}`} />
      ...
      <div className="p-4 border-t border-border-default space-y-3">
        ...
        <div className="bg-page p-3 rounded-xl border border-border-default flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-blue-500/20 border border-blue-500/30 flex items-center justify-center text-brand-primary font-bold text-xs">
              {role === 'admin' ? 'ADM' : 'USR'}
            </div>
