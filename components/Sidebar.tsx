...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, agentRunning }) => {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900/90 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between h-screen sticky top-0 backdrop-blur-xl z-20">
      <div>
        {/* Brand Header */}
        <div className="p-6 border-b border-slate-200 dark:border-slate-800/80 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Business Discovery SaaS</p>
            </div>
          </div>
        </div>
        ...
        <nav className="p-4 space-y-1.5">
          <p className="px-3 py-2 text-[10px] uppercase font-bold tracking-wider text-slate-500 dark:text-slate-400">Main Menu</p>
          {navItems.map((item) => {
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  isActive
                    ...
                    : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 hover:bg-slate-800/50'
                }`}
              >
                <div className="flex items-center gap-3">
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
        ...
        <div className="bg-slate-50 dark:bg-slate-950/60 p-3 rounded-xl border border-slate-200 dark:border-slate-800/60 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="overflow-hidden">
              <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">Araknet Workspace</p>
