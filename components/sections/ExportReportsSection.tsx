  ...
  return (
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-900/30 via-slate-900 to-slate-950 border border-blue-500/20 shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={exporting}
            className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-text-primary font-semibold text-xs shadow-lg shadow-blue-500/20 transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-xl bg-slate-800 hover:bg-slate-700 border border-border-default text-text-primary font-semibold text-xs transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* City Breakdown */}
        <div className="p-6 rounded-2xl bg-card border border-border-default backdrop-blur-md shadow-xl space-y-4">
