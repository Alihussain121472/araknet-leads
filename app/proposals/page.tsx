    ...
    <div className="min-h-screen bg-page text-text-primary flex flex-col">
      ...
      <header className="border-b border-border-default bg-card backdrop-blur sticky top-0 z-40 px-6 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className="p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-text-primary border border-border-default transition"
            title="Back to Dashboard"
          >
            <ArrowLeft className="w-4 h-4" />
          </Link>
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center shadow-md shadow-blue-500/20 text-text-primary font-bold text-sm">
        ...
        <div>
          <Link
            href="/"
            className="text-xs px-3 py-1.5 rounded-xl bg-brand-primary/20 hover:bg-brand-primary/30 text-brand-primary border border-blue-500/30 font-medium transition"
          >
            Dashboard
          </Link>
        </div>
